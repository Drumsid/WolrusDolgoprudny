                    ...
                    <div class="modal-body">
                      <form method="POST" action="{{ route('feedback') }}">
                          ...
                          <div id="first" class="my-hide-form">
                            ...
                            Я даю свое согласие на обработку персональных данных, указанных в анкете, на
                            неопределенный срок (сбор, накопление, хранение, уточнение, систематизация как на
                            бумажном носителе, так и с использованием информационных систем) Религиозная
                            организация Церковь христиан веры евангельской (пятидесятников) «Слово Жизни»
                            Долгопрудный (далее оператор) ОГРН – 11550000001969, ИНН – 5047169548, для
                            получения информационных писем/бюллетеней, журналов и открыток, при условии,
                            что оператор будет хранить мои персональные данные, соблюдая требования
                            законодательства РФ об обеспечении конфиденциальности. Я предупрежден(-а), что
                            мои ФИО и почтовый адрес в процессе почтовой рассылки, возможно, будут
                            переданы иной организации, имеющей право на почтовую рассылку.
                          </div>
