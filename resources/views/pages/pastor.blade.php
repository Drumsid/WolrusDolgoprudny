    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 text-padding pastor-head-text">
          ...
          <p>
            Мы служим вместе , чтим Божье присутствие и верим в спасение каждого человека. Родились и выросли в Томске, более 15 лет назад посвятили свою жизнь Богу и с тех пор большую часть своего времени посвящаем церкви и служению людям, у нас счастливый и крепкий брак, и взрослая дочь.
          </p>
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <div class="img-round-box text-center text-padding">
            <img src="{{ asset('assets/frontend/images/andrey-m3.jpg') }}" alt="" class="img-fluid pastor-img">
