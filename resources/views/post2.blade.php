...
@push('css')
<link href="{{ asset('assets/frontend/css/single-post/styles2.css') }}" rel="stylesheet">

<link href="{{ asset('assets/frontend/css/single-post/responsive2.css') }}" rel="stylesheet">
...
<div class="slider single-post-top-img">
...
<section class="post-area">
    <div class="container">
        ...
        <div style="z-index: 10; position: relative; top: -30px;" class="alert alert-success m-t-15" role="alert">
        {{ session('successMsg') }}  
        </div> 
        @endif
        <div class="row">
