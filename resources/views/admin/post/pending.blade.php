                            ...
                            <tbody>
                                @foreach ($posts as $key => $post)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($post->is_approved)
                                                <i class="badge bg-blue">Одобрено</i>
                                            @else
                                                <i class="badge bg-pink">Не одобрено</i>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($post->status)
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" class="btn btn-success" onclick="approvePost({{ $post->id }})" title="approve">
                                        ...
                                        <a href="{{ route('admin.post.edit', $post) }}" class="btn btn-info waves-effect" title="edit">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <button class="btn btn-danger waves-effect" onclick="deletePost({{ $post->id }})" title="delete">
